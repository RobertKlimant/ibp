...
(() => {
  ...
  var swipers = () => {
    ...
    const swiper_gallery = document.querySelector('[swiper-option="gallery"]');
    new Swiper(swiper_gallery, gallery_settings);
    const swiper_services = document.querySelector('[swiper-option="service"]');
    new Swiper(swiper_services, gallery_settings);
    const swiper_testimonial = document.querySelector('[swiper-option="testimonial"]');
    new Swiper(swiper_testimonial, blog_testimonial_settings);
    const swiper_blog = document.querySelector('[swiper-option="blog"]');
